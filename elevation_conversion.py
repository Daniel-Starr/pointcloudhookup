...
def install_egm2008_grid(proj_data_dir):
    ...
    try:
        ...
        grid_urls = [
            ...
            "https://download.osgeo.org/proj/vdatum/egm96_15/egm96_15.tif"
        ]
    ...
    try:
        ...
        try:
            ...
            transformer = pyproj.Transformer.from_pipeline(
                f"+proj=vgridshift +grids=egm96_15.gtx +multiplier=1"
            )
        ...
        # 方法3：使用区域经验值
        print("使用长沙地区经验值转换")
        return ellipsoidal_height - 28.0  # 长沙地区经验值
